...
// const { Categories } = require("./resorvers/Categories");
// const { Products } = require("./resorvers/Products");
...
const resolvers = {
  ...
  Category: {
    products: (parent, args, context) => {
      ...
      return products.filter((category) => category.id == categoryId);
    },
  },
  Product: {
    category: (parent, args, context) => {
      const categoryId = parent.categoryId;
      return products.find((product) => product.id == categoryId);
    },
  },
  // products:{
